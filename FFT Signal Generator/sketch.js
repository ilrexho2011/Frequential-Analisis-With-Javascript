...
function setup(){
  // Krijimi i sfondit te grafikut
  width = 0.9 * windowWidth;
  let canvas = createCanvas(width, height);
  canvas.parent('sketch-holder')

  // Rregullimi i gjeresise se kontrolleve
  document.querySelector('.controls').style.width = width + "px";

  // Perzgjedhesat e ngjyrimeve
  ...
  //Rreshqitesi i numrit te termave
  ...
  //Komandimi i ekuacioneve per valet sipas deshires
...
function draw(){
  ...
  document.querySelector(".number_of_terms").innerHTML = "Numri i Termave: " + slider_terms.value();
